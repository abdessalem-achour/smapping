...
echo_and_run cd "/home/abdessalem/smapping/src/openni2_camera/openni2_launch"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abdessalem/smapping/src/openni2_camera/openni2_launch/setup.py" \
     \
    build --build-base "/home/abdessalem/smapping/build/openni2_camera/openni2_launch" \
    install \
    --root="${DESTDIR-/}" \
