...
echo_and_run cd "/home/abdessalem/smapping/src/navigation/base_local_planner"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abdessalem/smapping/src/navigation/base_local_planner/setup.py" \
     \
    build --build-base "/home/abdessalem/smapping/build/navigation/base_local_planner" \
    install \
    --root="${DESTDIR-/}" \
