...
echo_and_run cd "/home/abdessalem/smapping/src/sem_mapping/Src/NeuralNet/tensorflow_object_detector"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/abdessalem/smapping/src/sem_mapping/Src/NeuralNet/tensorflow_object_detector/setup.py" \
     \
    build --build-base "/home/abdessalem/smapping/build/sem_mapping/Src/NeuralNet/tensorflow_object_detector" \
    install \
    --root="${DESTDIR-/}" \
