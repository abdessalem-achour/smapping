...
(cl:defmethod cl:initialize-instance :after ((m <LoadMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hypermap_msgs-srv:<LoadMap-request> is deprecated: use hypermap_msgs-srv:LoadMap-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <LoadMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hypermap_msgs-srv:<LoadMap-response> is deprecated: use hypermap_msgs-srv:LoadMap-response instead.")))
