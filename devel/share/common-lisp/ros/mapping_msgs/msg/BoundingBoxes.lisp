...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector mapping_msgs-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'mapping_msgs-msg:BoundingBox :initial-element (cl:make-instance 'mapping_msgs-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mapping_msgs-msg:<BoundingBoxes> is deprecated: use mapping_msgs-msg:BoundingBoxes instead.")))
...
(cl:defmethod image_header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mapping_msgs-msg:image_header-val is deprecated.  Use mapping_msgs-msg:image_header instead.")
  (image_header m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mapping_msgs-msg:BoundingBox))
