...
struct MD5Sum< ::mir_msgs::RobotStatus_<ContainerAllocator> >
{
  ...
  {
    return "38b4cd736e11dcb63d6a67a60bbb51c3";
  }

  static const char* value(const ::mir_msgs::RobotStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x38b4cd736e11dcb6ULL;
  static const uint64_t static_value2 = 0x3d6a67a60bbb51c3ULL;
};
