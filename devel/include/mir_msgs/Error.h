...
struct MD5Sum< ::mir_msgs::Error_<ContainerAllocator> >
{
  ...
  {
    return "d89ee38cee279c9a0b2fc5d02c3fe950";
  }

  static const char* value(const ::mir_msgs::Error_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd89ee38cee279c9aULL;
  static const uint64_t static_value2 = 0x0b2fc5d02c3fe950ULL;
};
