...
bool operator==(const ::mir_actions::MirMoveBaseActionFeedback_<ContainerAllocator1> & lhs, const ::mir_actions::MirMoveBaseActionFeedback_<ContainerAllocator2> & rhs)
{
...
struct MD5Sum< ::mir_actions::MirMoveBaseActionFeedback_<ContainerAllocator> >
{
  ...
  {
    return "8028ef11fcc6dd47ce8cdcf869f32b28";
  }

  static const char* value(const ::mir_actions::MirMoveBaseActionFeedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8028ef11fcc6dd47ULL;
  static const uint64_t static_value2 = 0xce8cdcf869f32b28ULL;
};
