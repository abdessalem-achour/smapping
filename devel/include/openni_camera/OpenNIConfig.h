...
namespace openni_camera
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(OpenNIConfig &config, const OpenNIConfig &max, const OpenNIConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const OpenNIConfig &config1, const OpenNIConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, OpenNIConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const OpenNIConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, OpenNIConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const OpenNIConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const OpenNIConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, OpenNIConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(OpenNIConfig::AbstractParamDescriptionConstPtr(new OpenNIConfig::ParamDescription<int>("image_mode", "int", 0, "Image output mode for the color/grayscale image", "{'enum': [{'name': 'SXGA_15Hz', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '1280x1024@15Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA_30Hz', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '640x480@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA_25Hz', 'type': 'int', 'value': 3, 'srcline': 12, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '640x480@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_25Hz', 'type': 'int', 'value': 4, 'srcline': 13, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_30Hz', 'type': 'int', 'value': 5, 'srcline': 14, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_60Hz', 'type': 'int', 'value': 6, 'srcline': 15, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@60Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_25Hz', 'type': 'int', 'value': 7, 'srcline': 16, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_30Hz', 'type': 'int', 'value': 8, 'srcline': 17, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_60Hz', 'type': 'int', 'value': 9, 'srcline': 18, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@60Hz', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'output mode'}", &OpenNIConfig::image_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(OpenNIConfig::AbstractParamDescriptionConstPtr(new OpenNIConfig::ParamDescription<int>("depth_mode", "int", 0, "depth output mode", "{'enum': [{'name': 'SXGA_15Hz', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '1280x1024@15Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA_30Hz', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '640x480@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA_25Hz', 'type': 'int', 'value': 3, 'srcline': 12, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '640x480@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_25Hz', 'type': 'int', 'value': 4, 'srcline': 13, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_30Hz', 'type': 'int', 'value': 5, 'srcline': 14, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_60Hz', 'type': 'int', 'value': 6, 'srcline': 15, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@60Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_25Hz', 'type': 'int', 'value': 7, 'srcline': 16, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_30Hz', 'type': 'int', 'value': 8, 'srcline': 17, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_60Hz', 'type': 'int', 'value': 9, 'srcline': 18, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@60Hz', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'output mode'}", &OpenNIConfig::depth_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(OpenNIConfig::AbstractParamDescriptionConstPtr(new OpenNIConfig::ParamDescription<int>("depth_mode", "int", 0, "depth output mode", "{'enum': [{'name': 'SXGA_15Hz', 'type': 'int', 'value': 1, 'srcline': 10, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '1280x1024@15Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA_30Hz', 'type': 'int', 'value': 2, 'srcline': 11, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '640x480@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VGA_25Hz', 'type': 'int', 'value': 3, 'srcline': 12, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '640x480@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_25Hz', 'type': 'int', 'value': 4, 'srcline': 13, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_30Hz', 'type': 'int', 'value': 5, 'srcline': 14, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QVGA_60Hz', 'type': 'int', 'value': 6, 'srcline': 15, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '320x240@60Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_25Hz', 'type': 'int', 'value': 7, 'srcline': 16, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@25Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_30Hz', 'type': 'int', 'value': 8, 'srcline': 17, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@30Hz', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'QQVGA_60Hz', 'type': 'int', 'value': 9, 'srcline': 18, 'srcfile': '/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg', 'description': '160x120@60Hz', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'output mode'}", &OpenNIConfig::depth_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_SXGA_15Hz = 1;
//#line 11 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_VGA_30Hz = 2;
//#line 12 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_VGA_25Hz = 3;
//#line 13 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_QVGA_25Hz = 4;
//#line 14 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_QVGA_30Hz = 5;
//#line 15 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_QVGA_60Hz = 6;
//#line 16 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_QQVGA_25Hz = 7;
//#line 17 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
      const int OpenNI_QQVGA_30Hz = 8;
//#line 18 "/home/abdessalem/smapping/src/openni_camera/openni_camera/cfg/OpenNI.cfg"
